...
import static by.bashlikovvv.bluetooth.model.BatteryState.UNKNOWN;
...
//    private int mNotificationIconLowBattery = R.drawable.ic_notification_low_battery;
    ...
    public GBDevice(String address, String name, String alias, String parentFolder) {
        this(address, null, name, alias, parentFolder);
    }

    public GBDevice(String address, String address2, String name, String alias, String parentFolder) {
        mAddress = address;
...
//    }
    ...
    public enum State {
        ...
        WAITING_FOR_RECONNECT("Waiting for connect"),
        WAITING_FOR_SCAN("WAITING_FOR_SCAN"),
        SCANNED("SCANNED"),
        CONNECTING("CONNECTING"),
        CONNECTED("CONNECTED"),
        INITIALIZING("INITIALIZING"),
        AUTHENTICATION_REQUIRED("AUTHENTICATION_REQUIRED"), // some kind of pairing is required by the device
        AUTHENTICATING("AUTHENTICATING"), // some kind of pairing is requested by the device
        /**
